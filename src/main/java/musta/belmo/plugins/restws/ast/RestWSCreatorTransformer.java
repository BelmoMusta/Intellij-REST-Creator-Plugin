...
public class RestWSCreatorTransformer implements Transformer {
    ...
    private PsiMethod createMethod(PsiClass psiClass) {
        ...
        PsiMethod method = psiElementFactory.createMethod(wsSignature.getMethodName(), type);
        ...
        PsiAnnotation psiAnnotation = PsiAnnotationUtils.addAnnotation(method, wsSignature.getAnnotation());
